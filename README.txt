...
a persistence unit "parking_appPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "parking_app/pom.xml":
...
artifact ("parking_app.war") is already built. You can build
